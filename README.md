...
Asesmen ini bertujuan untuk mengukur kemampuan mahasiswa dalam mengimplementasikan machine learning untuk klasifikasi citra tulisan menggunakan HOG Feature Extraction dan Support Vector Machine (SVM) dengan datset EMNIST Letters.
1. memahami penerapan praktis HOG dan SVM dalam pengenalan karakter tulisan tangan.
2. mampu melakukan eksperimen sistematis (tuning dan validasi) pada model machine learning.
3. melakukan evaluasi performa model dengan metode leave-one-out cross-validation (LOOCV), serta menampilkan confusion matrix, accuracy, precision dan F1-core.
4. menguasi analisis performa model klasifikasi berbasis data citra dan menunjukan kemampuan komunikasi ilmiah melalui dokumentasi dan presentasi video.
